...
# python Learn_KoopmanNonlinearA_with_KlinearEig.py --K_train_samples 20000 --env "Pendulum-v1"
...
# python Learn_Knonlinear_RNN.py --K_train_samples 20000 --env "Pendulum-v1"
...
# python Learn_DKN_gxu.py --K_train_samples 20000 --env "Pendulum-v1"
