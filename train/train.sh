...
# python Learn_Koopman_with_KlinearEig.py --K_train_samples 20000 --env "Pendulum-v1"
...
# python Learn_Knonlinear.py --K_train_samples 20000 --env "Pendulum-v1"
...
# python Learn_KoopmanNonlinear_with_KlinearEig.py --K_train_samples 20000 --env "Pendulum-v1"
...
# python Learn_KoopmanNonlinearA_with_KlinearEig.py --K_train_samples 20000 --env "LunarLanderContinuous-v2"
...
# python Learn_Knonlinear_RNN.py --K_train_samples 20000 --env "LunarLanderContinuous-v2"
...
python Learn_DKN_gxu1.py --K_train_samples 20000 --env "Pendulum-v1"
python Learn_DKN_gxu1.py --K_train_samples 20000 
